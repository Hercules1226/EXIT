...
// Cross Module References
	EXIT_API UEnum* Z_Construct_UEnum_EXIT_EGameState();
...
// End Cross Module References
	static UEnum* EGameState_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_EXIT_EGameState, Z_Construct_UPackage__Script_EXIT(), TEXT("EGameState"));
		}
		return Singleton;
	}
	template<> EXIT_API UEnum* StaticEnum<EGameState>()
	{
	...
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_EXIT();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EGameState"), 0, Get_Z_Construct_UEnum_EXIT_EGameState_Hash(), false);
#else
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ABoss_Statics::NewProp_mState = { "mState", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABoss, mState), Z_Construct_UEnum_EXIT_EGameState, METADATA_PARAMS(Z_Construct_UClass_ABoss_Statics::NewProp_mState_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABoss_Statics::NewProp_mState_MetaData)) };
	...
	IMPLEMENT_CLASS(ABoss, 3053674951);
